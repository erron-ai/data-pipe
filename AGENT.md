...
## Objective
Maintain `data-pipe` as a reliable, useful, and test-first project aligned with its primary promise:
> CLI ingestion pipeline from business tools into agent-ready formats.
